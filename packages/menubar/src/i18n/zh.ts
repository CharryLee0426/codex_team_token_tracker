...
选项：
  ...
  cliStatusPricing: "价目表",
  cliStatusPricingSynced: "来自后端的 {models} 个模型 · {when}下载 · OpenAI 官方价目更新于 {date}",
  cliStatusPricingSeed: "来自后端的 {models} 个模型（内置价目；后端尚未读取 OpenAI 页面）· {when}下载",
  cliStatusPricingNone: "内置价目（尚未从后端下载）",
  cliStatusAccount: "账号",
  cliStatusDirs: "会话目录",
