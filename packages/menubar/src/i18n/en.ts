...
Options:
  ...
  cliStatusPricing: "Pricing",
  cliStatusPricingSynced: "{models} models from the backend · downloaded {when} · OpenAI list as of {date}",
  cliStatusPricingSeed: "{models} models from the backend (bundled list; the backend has not read OpenAI's page yet) · downloaded {when}",
  cliStatusPricingNone: "bundled list (not downloaded from the backend yet)",
